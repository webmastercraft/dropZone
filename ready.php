...
<html lang="en">
  ...
  <body style="background-color:#e2dfdf;">
    
    <div class="container text-center" style="margin-top:10rem;">
        <div class="spinner-border text-dark mb-3" role="status">
            <span class="visually-hidden">Loading...</span>
          </div>
      <h3 style="font-weight:500;">Video in processing</h3>
      <p>Please wait a few seconds. We'll refresh this page when it's ready.    </p>
